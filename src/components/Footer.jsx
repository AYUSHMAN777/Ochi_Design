...
function Footer() {
    return (
        <div className='border-t-[1px] border-[#000] flex  gap-0 pt-[7vw] pb-[2vw] w-full h-screen font-["Neue_Montreal"] bg-[#F1F1F1]'>
            <div className="flex flex-col justify-between  px-[5vw] w-1/2 h-full text-zinc-900 text-8xl font-[1000] tracking-tighter leading-[7vw] uppercase ">
                <div className="heading">
                    <h1 className="">EYE-</h1>
                    <h1 className=" tracking-tighter" >Opening</h1>
                </div>
            ...
            <div>
                <div className=" w-1/2 font-['Neue_Montreal']  -mt-[2.2vw] text-zinc-900 h-full " >
                    <h1 className="uppercase tracking-tighter pr-[2vw] text-[6.7vw] font-extrabold">Presentations</h1>
                    <div className="text-[#000]">
                        <a className="text-xl block font-medium hover:text-[#8d8b8b]" href="#">Instagram</a>
                        <a className="text-xl block font-medium hover:text-[#8d8b8b]" href="#">Facebook</a>
                        <a className="text-xl block font-medium hover:text-[#8d8b8b]" href="#">Twitter</a>
                    </div>
                </div>
                <div className="w-full">
                    <div className=" text-[#8d8b8b] h-full flex justify-between w-full pr-[2vw]">
                        <h1>&copy; ochi design 2024 </h1>
                        <h1>Website by Ayushman</h1>
                    </div>
                </div>
            </div>
        </div>
